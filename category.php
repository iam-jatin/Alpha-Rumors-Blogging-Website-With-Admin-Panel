...
<head>
  ...
  <link rel="icon" href="">
  <title>Alpha Rumors | Category</title>
  ...
  <div class="" >
    <div class="container">
      <div class="row d-flex justify-content-center">
        <h4 style="font-family:'times roman';"><b><?php echo htmlentities($row['category']);?> News</b></h4>
      </div>
    </div>
  </div>
          ...
          <div class="card mb-4"> <img class="card-img-top" src="admin/postimages/<?php echo htmlentities($row['PostImage']);?>" alt="<?php echo htmlentities($row['posttitle']);?>" width="400" height="350">
            <div class="card-body rounded-lg">
              ...
              <h6 style="font-family:'times roman';"><b>Category : </b><b> <a href="category.php?catid=<?php echo htmlentities($row['cid'])?>"><?php echo htmlentities($row['category']);?></a></b> </h6>
